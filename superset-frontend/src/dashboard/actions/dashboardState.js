...
const updateDashboardMetadata = async (id, metadata, dispatch, getState) => {
  ...
  if (!dash_edit_perm) {
    console.log('[updateDashboardMetadata] Skipping save - user lacks edit permissions (dash_edit_perm=false)');
    return;
  }
...
export const updateDashboardLabelsColor = () => async (dispatch, getState) => {
  ...
  if (!dash_edit_perm) {
    console.log('[updateDashboardLabelsColor] Skipping update - user lacks edit permissions (dash_edit_perm=false)');
    return;
  }
