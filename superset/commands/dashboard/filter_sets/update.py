...
class UpdateFilterSetCommand(BaseCommand):
    def __init__(self, dashboard_id: int, set_id: str, label: str) -> None:
    ...
    def run(self) -> str:
        ...
        found = False
        for fs in sets:
            if fs.get("id") == self._set_id:
                fs["customLabel"] = self._label
                found = True
                break
